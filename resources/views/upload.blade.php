    ...
    <header id="Header" class="overflow-hidden py-10 delay-[300ms] duration-[600ms] taos:scale-[0.6] taos:opacity-0">
        <div class="container mx-auto py-0 flex justify-center">
            <div class="w-full py-0 px-5 md:px-10">
                ...
                <form class="py-10 font-robotoserif px-5" method="POST" action="{{ url('/upload') }}" onsubmit="return confirmSubmit()" enctype="multipart/form-data">
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <label class="block mb-2 text-sm font-medium text-black-1E1E1E" for="profil">Unggah Foto Profil</label>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <label class="block mb-2 text-sm font-medium text-black-1E1E1E" for="gambar">Unggah Cover Tulisan</label>
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <label class="block mb-2 text-sm font-medium text-black-1E1E1E" for="file">Unggah File</label>
                        <input class="block w-full text-sm text-black-1E1E1E border-0 border-b-2 border-gray-300 rounded-lg cursor-pointer focus:outline-none" id="file" name="file" type="file" required>
                        <p class="font-normal py-2 md:text-start text-center text-red-600">
                            *upload dengan format .pdf, .doc, dan .docx <br>
                            *max file size 2MB
                        </p>
                    </div>
