                ...
                <div class="py-4 text-black-1E1E1E">
                    ...
                    <ul>
                        ...
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold text-black-1E1E1E transition-colors duration-150" href="{{ url('/dashboard/team') }}">
                ...
                <main class="h-full overflow-y-auto">
                    <div class="container px-6 mx-auto grid">
                        <div class="flex justify-between items-center">
                            ...
                            <a type="button" href="{{ url('/dashboard/team') }}" class="focus:outline-none text-white-fafafa bg-yellow-400 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2">
                        ...
                        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                            ...
                            <form class="py-3 font-roboto px-5" method="POST" action="{{ url('/dashboard/team-updates') }}" onsubmit="return confirmSubmit()" enctype="multipart/form-data">
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    ...
                                    <label for="nama" class="peer-focus:font-medium absolute text-sm text-black-1E1E1E duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nama</label>
                                </div>
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="posisi" id="posisi" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-black-1E1E1E border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ $posisi }}" required />
                                    <label for="posisi" class="peer-focus:font-medium absolute text-sm text-black-1E1E1E duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Posisi</label>
                                </div>
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="divisi" id="divisi" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-black-1E1E1E border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ $divisi }}" required />
                                    <label for="divisi" class="peer-focus:font-medium absolute text-sm text-black-1E1E1E duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Divisi</label>
                                </div>
                                <div class="relative z-0 w-full mb-6 group">
