                ...
                <main class="h-full overflow-y-auto">
                    <div class="container px-6 mx-auto grid">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ url('/dashboard/team-add') }}" type="button" class="focus:outline-none text-white-fafafa bg-green-400 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2">
                                + <span class="px-2"> | </span> Team
                            </a>
                        </div>                      
                        <!-- New Table -->
                                ...
                                <table class="w-full whitespace-no-wrap">
                                    ...
                                    <tbody class="bg-white-fafafa divide-y">
                                        ...
                                        <tr class="text-black-1E1E1E">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <img src="{{ asset('storage/uploads/team/'.$row->gambar) }}" alt="{{ $row->gambar }}" title="{{ $row->judul }}" />
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                {{ $row->nama }}
                                            </td>
