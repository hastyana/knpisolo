                ...
                <main class="h-full overflow-y-auto">
                    <div class="container px-6 mx-auto grid">
                        ...
                        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                            ...
                            <form class="py-3 font-roboto px-5" method="POST" action="{{ url('/dashboard/galeri-video-add') }}" onsubmit="return confirmSubmit()" enctype="multipart/form-data">
                                ...
                                <div class="relative z-0 w-full mb-6 group">
                                    <input type="text" name="link" id="link" class="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2 text-black-1E1E1E border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:broder-blue-56A5ED peer" value="{{ $link }}" required />
                                    <label for="link" class="peer-focus:font-medium absolute text-sm text-black-1E1E1E duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-56A5ED peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Link</label>
                                </div>
