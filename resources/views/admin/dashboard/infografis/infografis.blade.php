                ...
                <main class="h-full overflow-y-auto">
                    <div class="container px-6 mx-auto grid">
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ url('/dashboard/infografis-add') }}" type="button" class="focus:outline-none text-white-fafafa bg-green-400 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2">
                                + <span class="px-2"> | </span> Infografis
                            </a>
                        </div>                      
                        <!-- New Table -->
                            ...
                            <div class="w-full overflow-x-auto py-10">
                                <div class="grid grid-cols-4">
                                    ...
                                    <div class="flex flex-row justify-center items-end">
                                        <img src="{{ asset ('storage/'.$row->gambar) }}" alt="{{ $row->gambar }}" title="{{ $row->kategori }}" class="w-64 h-72 p-1" />
