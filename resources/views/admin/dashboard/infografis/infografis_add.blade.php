                ...
                <div class="py-4 text-black-1E1E1E">
                    ...
                    <ul>
                        ...
                        <li class="relative px-6 py-3">
                            ...
                            <a class="inline-flex items-center w-full text-sm font-semibold text-black-1E1E1E transition-colors duration-150" href="{{ url('/dashboard/infografis') }}">
                ...
                <main class="h-full overflow-y-auto">
                    <div class="container px-6 mx-auto grid">
                        <div class="flex justify-between items-center">
                            ...
                            <a type="button" href="{{ url('/dashboard/infografis') }}" class="focus:outline-none text-white-fafafa bg-yellow-400 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2">
                        ...
                        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                            ...
                            <form class="py-3 font-roboto px-5" method="POST" action="{{ url('/dashboard/infografis-add') }}" onsubmit="return confirmSubmit()" enctype="multipart/form-data">
